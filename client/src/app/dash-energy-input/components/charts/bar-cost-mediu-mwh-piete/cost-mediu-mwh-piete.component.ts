...
@Component({
  selector: 'app-cost-mediu-mwh-piete',
  templateUrl: './cost-mediu-mwh-piete.component.html',
  styleUrls: ['./cost-mediu-mwh-piete.component.scss']
})
export class CostMediuMwhPieteComponent implements OnInit {
